        ...
        {users.map(user => (
          <div key={user.id}
            ...
            <div>
              ...
              <div style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', color: '#4a5240', marginTop: '2px' }} className="uppercase">{user.email}</div>
            ...
            <div className="text-right">
              <div style={{ fontFamily: 'var(--font-display)', fontSize: '28px', color: '#d4a017' }}>{user.letter_credits}</div>
              <div style={{ fontFamily: 'var(--font-mono)', fontSize: '9px', color: '#4a5240' }} className="uppercase">Credits · {user.plan}</div>

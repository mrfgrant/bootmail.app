...
export default function DashboardPage() {
  ...
  useEffect(() => {
    async function load() {
      try {
        ...
        if (rErr) {
          console.error('Recruits error:', rErr)
  ...
  return (
    <div>
      ...
      {error && (
        <div style={{ background: 'rgba(192,57,43,0.1)', border: '1px solid rgba(192,57,43,0.3)', padding: '12px 16px', marginBottom: '24px' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0.5">
            {recruits.map(r => (
              <div key={r.id} style={{ background: '#ffffff', borderTop: '4px solid #4a5240' }} className="p-6">
                ...
                {r.address_line1
                  ? <div style={{ fontFamily: 'var(--font-body)', fontSize: '12px', color: '#999', fontStyle: 'italic' }} className="mb-4">
      ...
      <div>
        <div style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', letterSpacing: '4px', color: '#6b7560' }} className="uppercase mb-4">
          Quick Actions
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-0.5">
          {[
            ...
            <Link key={a.href} href={a.href}
              ...
              className="p-6 block hover:border-olive transition-all">
      ...
      <div style={{ background: '#1a1a16', marginTop: '32px' }} className="p-6 flex items-center justify-between">
        <div>
          <div style={{ fontFamily: 'var(--font-mono)', fontSize: '10px', letterSpacing: '3px', color: '#6b7560' }} className="uppercase mb-1">
            Letter Credits
          </div>
